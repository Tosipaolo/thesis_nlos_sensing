...
\puttitle{
	...
	coadvisor={Marcus Henninger, Silvio Mandelli}, % Co-Supervisor name, remove this line if there is none
...
\chapter{Appendix B}
It may be necessary to include another appendix to better organize the presentation of the additional material.
