...
\section{Proof of concept architecture}
	...
	The \gls{spu} receives the complex IQ signal,  after FFT and removal of the cyclic prefix (CP), as input for further sensing processing on a per-radio frame basis \cite{Wild_Grudnitsky_Mandelli_Henninger_Guan_Schaich_2023}.
	
	Using option 7-2 of the proposed 5G splits, it is possible to use the same type of Radio Unit (RU) for both communication and sensing.
