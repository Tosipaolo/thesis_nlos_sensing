...
These methods mostly rely on Cell Identity (CID), time of arrival (TOA) and Global Navigation Satellite System (GNSS). Due to the accuracy requirements in different deployment conditions (\ie indoor or outdoor, urban or rural areas), LTE positioning normally employed two or more methods at the same time \cite{Razavi_Gunnarsson_2018}. 
