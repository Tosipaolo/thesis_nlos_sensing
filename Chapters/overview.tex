...
This enables the UE to estimate the positions of active user equipment (UE) by measuring the time difference of arrival \cite{Keating_Saily_Hulkkonen_Karjalainen_2019}.
...
\section{Sensing use-cases}
	...
	While not yet an established solution, this work delves into the prospective feasibility of non-line-of-sight sensing and its use-case possibilities in ISAC.
	
	Non-line-of-sight sensing could potentially offer a range of potential advantages.
